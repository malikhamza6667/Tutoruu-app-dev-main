...
const Button: React.FC<Props> = (props) => {
    ...
    return (
        ...
        <TouchableOpacity
            style={{
                backgroundColor: props.disabled ? Colors.gray : props.color, elevation: props.elevation ? props.elevation : 0,
        ...
        >
            {
                props.image == undefined || null ? <Text
                    style={{ color: props.titleColor ? props.titleColor : 'white', alignSelf: 'center', fontFamily: 'PoppinsBold', fontSize: props.textSize ? props.textSize : 18 }}
                    ...
                    <View className="flex-row  items-center">
                        ...
                        <View className=" " style={{ width: wp('63%'), alignItems: 'center', justifyContent: 'center' }}>

                            <Text
                                style={{ color: props.titleColor ? props.titleColor : 'white', fontSize: props.textSize ? props.textSize : hp('1.7'), fontFamily: 'PoppinsBold', textAlign: 'center' }}
